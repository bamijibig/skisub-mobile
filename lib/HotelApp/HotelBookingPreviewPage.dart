 ...
 Future<void> _confirmhotelBooking(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        SnackBar(content: Text('Fund wallet, insufficient fund.')),
      );
    }
  }
  @override
...
//         'https://jpowered.pythonanywhere.com/account/api/token/refresh/',
//         options: Options(headers: {
...
//         if (newToken != null) {
//           return _confirmhotelBooking(context);
//         } else {
//           ScaffoldMessenger.of(context).showSnackBar(
...
//                         _buildRow('Guests', booking['guest'].toString()),
//                         SizedBox(height: 10),
//                         _buildRow('Apartment', roomType.name),
//                       ],
//                     ),
//                   ),
//                   Divider(),
