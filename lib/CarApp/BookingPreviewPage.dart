...
class _BookingPreviewPageState extends State<BookingPreviewPage> {
  ...
  Future<void> _fetchBookingDetails() async {
    final dio = Dio();
    final String apiUrl = 'https://skissub.pythonanywhere.com/car/api/listcarbooking/${widget.bookingId}/';
  ...
  Future<void> _confirmBooking(BuildContext context) async {
    final dio = Dio();
    final String apiUrl = 'https://skissub.pythonanywhere.com/car/api/orders/';
